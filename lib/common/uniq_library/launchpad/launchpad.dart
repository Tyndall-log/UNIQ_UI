...
extension LaunchpadManager on UniqLibrary {
  ...
  // launchpad_list_get
  static late final Pointer<Uint64> Function(Pointer<Uint64>)
      _launchpadListGet = UniqLibrary._uniqLibrary!.lookupFunction<
  ...
  static List<int> launchpadListGet() {
    final Pointer<Uint64> sizePtr = malloc<Uint64>();
...
extension Launchpad on UniqLibrary {
  // ==================== Launchpad Start ====================
  // rgb_set
  static late final void Function(int, int, int, int, int, int) _rgbSet =
  ...
  // velocity_set
  static late final void Function(int, int, int, int) _velocitySet =
      UniqLibrary._uniqLibrary!.lookupFunction<
  ...
  // program_mode_set
  static late final void Function(int, bool) _programModeSet = UniqLibrary
      ._uniqLibrary!
  ...
  static late final void Function(int, bool) _automaticTransmissionSet =
      UniqLibrary._uniqLibrary!.lookupFunction<Void Function(Uint64, Bool),
          void Function(int, bool)>('automatic_transmission_set');
  ...
  static late final void Function(int, bool) _immediateTransmissionSet =
      UniqLibrary._uniqLibrary!.lookupFunction<Void Function(Uint64, Bool),
          void Function(int, bool)>('immediate_transmission_set');
